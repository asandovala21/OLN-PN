* indicadores  : número de conmutantes
...
.table = .ol_table.new
  ...
  * I-O
  .table.src       = "ene"
  .table.varlist0  = "_conmutante_v1 _ocupado _region_re_v1 _region_tr_v1"
...
.table.export_excel bh, file("tabla 03-18")
.table.export_excel cv, file("tabla 03-18")
